...
const HeaderBoottom = () => {
    ...
    return (
        <div className='w-full px-4 h-[36px] bg-amazon_light text-white items-center'>
            {/*ListItems Start here  */}
            <ul className='flex items-center  gazp-2 text-sm tracking-wide'>
